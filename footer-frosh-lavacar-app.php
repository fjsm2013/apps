    ...
    <div class="row">
      <div class="col-lg-4 mb-4">
        ...
        <div class="d-flex gap-3 mt-4">
          ...
          <a href="#" class="text-white" aria-label="WhatsApp"><i class="fab fa-whatsapp"></i></a>
        </div>
      </div>
      ...
      <div class="col-lg-4 mb-4">
        ...
        <ul class="list-unstyled">
          <li class="mb-3">
            ...
            <a href="mailto:info@xxxx.com" class="text-decoration-none text-light">info@xxxx.com</a>
          </li>
          <li class="mb-3">
            <i class="fas fa-phone me-2"></i>
            <a href="tel:+50688888888" class="text-decoration-none text-light">+506 83239015</a>
          </li>
          <li>
